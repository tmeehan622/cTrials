...
typedef NS_ENUM(unsigned int, FlurryEventRecordStatus) {
    FlurryEventFailed = 0,
    FlurryEventRecorded,
...
typedef NS_ENUM(unsigned int, FlurrySyndicationEvent) {
...
typedef NS_ENUM(unsigned int, FlurryTransactionRecordStatus) {
